...
def test_result_state(fixture_random_seed):
    H = qutip.rand_dm(2, seed=fixture_random_seed)
...
def test_result_state_ValueError(fixture_random_seed):
    H = qutip.rand_dm(2, seed=fixture_random_seed)
    tlist = np.linspace(0, 3*np.pi, 2)
...
def test_anim_wigner_sphere(fixture_random_seed):
...
def test_anim_hinton(fixture_random_seed):
...
def test_anim_matrix_histogram(fixture_random_seed):
    rho = qutip.rand_dm(5, seed=fixture_random_seed)
    rhos = [rho]*2
...
def test_anim_fock_distribution(fixture_random_seed):
    rho = qutip.rand_dm(5, seed=fixture_random_seed)
    rhos = [rho]*2
...
def test_anim_wigner(fixture_random_seed):
    rho = qutip.rand_dm(5, seed=fixture_random_seed)
    rhos = [rho]*2
...
def test_anim_qfunc(fixture_random_seed):
    rho = qutip.rand_dm(5, seed=fixture_random_seed)
    rhos = [rho]*2
